...
public class IndexModel : PageModel
{
    ...
    {
        var devUserId = int.TryParse(User.FindFirst("IdUsuario")?.Value, out var du) ? du
        ...
        var resultado = await _service.ReestablecerPiezaAsync(codigoBarras, idTienda, devUserId, usuario);
